...
public enum SetterMsg {
    INFO_INITIALIZE_SETTER(Status.INFO,Content.COMPLETE_INITIALIZE_SETTER),
    ERROR_INITIALIZE_SETTER(Status.ERROR,Content.NOTCOMPLETE_INITIALIZE_SETTER);

    private final Status status;
    private final Content content;

    SetterMsg(final Status status, final Content content){
